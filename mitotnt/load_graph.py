...
class GraphLoader:
	...
	def drawGraph3D(self, graphObject, color, draw_axes=False, draw_lines=False, fill_between=False):
	...
	def trackMaximumVote(self, frame_graph_obj_1, frame_graph_obj_2, inverted=False, threshold=5, mode='segment'):
		...
		if mode == 'segment':
			...
			raise ValueError("Only implemented for mode = 'segment' or 'fragment'")
